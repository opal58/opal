      ...
      <form method="post" action="/opalproject/csignex" >
         <table>
          ...
          <label for="radio"><input id= "radio" type="radio" name="member" disabled>파트너</label>
               ...
               <tr>
                  ...
                  <td class="td_text">
                  		<input id="cust_name" style="width: 200px; text-align: left;" type="text" name="cust_name" autocomplete=”off” maxlength="6" required autofocus>&nbsp;&nbsp;<span id="namecheck"></span>
                  </td>
               </tr>
               ...
               <tr>
                  ...
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="text" id="cust_id" name="cust_id" autocomplete=”off”  maxlength="10" required>&nbsp;&nbsp;<span id="idcheck"></span></td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td class="td_text">
                  <input id="cust_pwch" style="width: 200px; text-align: left;" type="password" autocomplete=”off” min=6 max=11 required> <span id="pwch"></span>
         ...
         <div class="button">
            <input type="submit" class="btn btn-success" value="회원가입" id ="submit"> <input
               onclick="location.href='/opalproject/index'" type="button"
